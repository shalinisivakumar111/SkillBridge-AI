...
if find_jobs:
    ...
    st.caption("Skills below are missing from your profile but appear in the strongest nearby job matches. Priorities are based on how often the skill is required across the displayed jobs.")
    ...
    # Map first, then cards.
    st.markdown("## 🗺️ OpenStreetMap / Leaflet")
